            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
                ...
                <form onSubmit={handleSubmit(handleAddTicket)}>
                    ...
                    <div className="sm:flex sm:flex-row-reverse flex gap-4">
                        <button className="w-fit cursor-pointer rounded-lg text-sm px-5 py-2 focus:outline-none h-[50px] border bg-violet-500 hover:bg-violet-600 focus:bg-violet-700 border-violet-500-violet- text-white focus:ring-4 focus:ring-violet-200 hover:ring-4 hover:ring-violet-100 transition-all duration-300">
